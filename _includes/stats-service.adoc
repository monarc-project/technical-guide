...
An architecture of Monarc Front Offices and Back Offices instance(s) communicated with Stats Service(s) and Global Statistics can be found link:https://monarc-stats-service.readthedocs.io/en/latest/architecture.html[*here*].
...
The installation instructions as well as system requirements can be found link:https://monarc-stats-service.readthedocs.io/en/latest/installation.html[here].
